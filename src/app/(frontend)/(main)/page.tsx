  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        >
          {/* Main diamond shape: Has fill and stroke */}
          <path
            ...
            strokeWidth="3.445"
          ></path>
          {/* Sparkle lines: Stroke only, no fill */}
          <path
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              >
                <ShadowWrapper>
                  <Card className="relative bg-card text-card-foreground border-[3px] border-border rounded-lg shadow-none h-full">
                    <CardHeader>
