  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <motion.div
        ...
        animate="visible"
      >
        <div className="relative flex flex-col items-center justify-center text-center pt-12 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-2">
          <svg
            className="hidden md:block absolute h-auto w-12 md:w-16 lg:w-20 flex-shrink-0 p-2 left-0 translate-y-16 md:translate-y-20 lg:-translate-y-42 -translate-x-2 md:-translate-x-4 lg:-translate-x-8 xl:-translate-x-20"
            viewBox="0 0 91 98"
          ...
          <motion.h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight mb-4 sm:mb-6 z-10 leading-tight"
          ...
          <svg
            className="hidden md:block absolute w-12 md:w-16 lg:w-20 h-auto flex-shrink-0 right-0 bottom-0 -translate-y-8 md:-translate-y-12 lg:-translate-y-24 translate-x-12 md:translate-x-15 lg:translate-x-15 xl:translate-x-15"
            viewBox="0 0 92 80"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
          ...
          <motion.p
            className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl z-10 leading-relaxed px-2"
            variants={itemVariants}
          >
          ...
          <motion.div
            className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 z-10 w-full sm:w-auto"
            variants={itemVariants}
          >
            <div className="relative group w-full sm:w-auto">
              ...
              <Button
                size="lg"
                className="relative bg-brand text-primary-foreground border-[3px] border-border hover:bg-brand/90 w-full sm:w-auto text-base sm:text-lg px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-5 rounded-lg"
                asChild
              >
                <Link href="/login">
            ...
            <div className="relative group w-full sm:w-auto">
              ...
              <Button
                size="lg"
                variant="outline"
                className="relative bg-background text-foreground border-[3px] border-border hover:bg-background/90 w-full sm:w-auto text-base sm:text-lg px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-5 rounded-lg"
                asChild
              >
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-2">
          <motion.div
              ...
              >
                <Card className="border-[3px] border-border bg-card rounded-2xl shadow-lg h-full transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-2xl hover:-translate-y-1">
                  <CardHeader className="pb-3 sm:pb-4 p-4 sm:p-6">
                    <item.icon className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-brand mb-2 sm:mb-3 md:mb-4" />
                    ...
                    {item.bullets && (
                      <ul className="space-y-1.5 sm:space-y-2">
                        {item.bullets.map((bullet, bulletIndex) => (
                          ...
                          >
                            <div className="w-1.5 h-1.5 bg-brand rounded-full flex-shrink-0 mt-1.5 sm:mt-2" />
      ...
      <motion.section
        className="py-12 sm:py-16 md:py-20 lg:py-28 bg-gradient-to-b from-background to-muted/10"
        variants={containerVariants}
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <motion.div
            ...
            variants={itemVariants}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-4 sm:mb-6 md:mb-8 leading-tight">
              Everything You Need
            </h2>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground/80 max-w-4xl mx-auto font-medium px-2">
              A complete platform to build, deploy, and manage intelligent AI
              agents that work seamlessly with your existing systems
            </p>
          </motion.div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20 lg:mb-24">
            {/* Custom Actions */}
            <div className="lg:col-span-7">
              <Card className="border-2 border-border/30 bg-gradient-to-br from-card to-card/80 rounded-2xl md:rounded-3xl shadow-xl overflow-hidden transition-all duration-300 ease-out hover:scale-[1.01] hover:shadow-2xl hover:border-brand/30">
                <CardContent className="p-6 sm:p-8 md:p-10 lg:p-14">
                  <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-6 sm:mb-8">
                    <div className="bg-brand/15 p-3 sm:p-4 rounded-2xl md:rounded-3xl flex-shrink-0">
                      <Zap className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 text-brand" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4 leading-tight">
                        Turn Conversations Into Actions
                      </h3>
                      <p className="text-base sm:text-lg md:text-xl text-muted-foreground/80 mb-6 sm:mb-8 font-medium leading-relaxed">
                      ...
                      {/* Demo conversation */}
                      <div className="bg-muted/50 rounded-xl md:rounded-2xl p-3 sm:p-4 space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                        <div className="flex items-start space-x-2">
                          <div className="bg-blue-500 text-white rounded-full p-1 flex-shrink-0">
                            <Users className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
                          </div>
                          <div className="bg-background rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 max-w-[180px] sm:max-w-[200px] border-2 border-border">
                        ...
                        <div className="flex items-start space-x-2 justify-end">
                          <div className="bg-brand text-primary-foreground rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 max-w-[200px] sm:max-w-[250px]">
                            <p className="text-xs sm:text-sm">
            ...
            <div className="lg:col-span-5 space-y-4 sm:space-y-6">
              <Card className="border-2 border-border/40 bg-gradient-to-br from-card to-card/90 rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 transition-all duration-200 ease-out hover:scale-[1.02] hover:shadow-xl hover:border-primary/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-12 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <Card className="border-2 border-border/30 bg-gradient-to-br from-card to-card/80 rounded-2xl md:rounded-3xl shadow-xl overflow-hidden transition-all duration-300 ease-out hover:scale-[1.01] hover:shadow-2xl hover:border-brand/30">
                <CardContent className="p-6 sm:p-8 md:p-10 lg:p-14">
                  <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-6 sm:mb-8">
                    <div className="bg-primary/15 p-3 sm:p-4 rounded-2xl md:rounded-3xl flex-shrink-0">
                      <FileText className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 text-primary" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4 leading-tight">
                      ...
                      {/* Knowledge base demo */}
                      <div className="bg-muted/50 rounded-xl md:rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6">
                        <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                          <FileText className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
                          <span className="text-sm sm:text-base font-medium">Knowledge Base</span>
                          <span className="text-xs bg-green-500/10 text-green-600 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
                            1,247 docs
                          </span>
                        </div>
      ...
      <motion.section
        className="py-8 sm:py-12 md:py-16 bg-gradient-to-b from-muted/15 to-background overflow-hidden"
        variants={containerVariants}
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-20 mb-12 sm:mb-16 md:mb-20">
            {/* Customer Support */}
            <motion.div className="group" variants={itemVariants}>
              <Card className="border-2 border-border/30 bg-gradient-to-br from-card to-card/80 rounded-2xl md:rounded-3xl shadow-xl overflow-hidden transition-all duration-300 ease-out hover:scale-[1.01] hover:shadow-2xl hover:-translate-y-1 h-full">
                <CardHeader className="pb-6 sm:pb-8 pt-6 sm:pt-8 md:pt-10 px-4 sm:px-6 md:px-8 lg:px-10">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-4 sm:mb-6">
                    <div className="bg-blue-500/15 p-3 sm:p-4 rounded-2xl md:rounded-3xl flex-shrink-0">
                      <MessageSquare className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-2 sm:mb-3">
                        Customer Support
                      </h3>
                      <p className="text-sm sm:text-base md:text-lg text-muted-foreground/80 font-medium leading-relaxed mb-3 sm:mb-4">
                  ...
                  {/* Mock conversation */}
                  <div className="bg-muted/50 rounded-xl md:rounded-2xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-start space-x-2">
                      <div className="bg-blue-500 text-white rounded-full p-1 flex-shrink-0">
                        <Users className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
                      </div>
                      <div className="bg-background rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 max-w-[160px] sm:max-w-[200px] border-2 border-border">
                        <p className="text-xs sm:text-sm">
                    ...
                    <div className="flex items-start space-x-2 justify-end">
                      <div className="bg-blue-500 text-white rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 max-w-[180px] sm:max-w-[200px]">
                        <p className="text-xs sm:text-sm">
            ...
            <motion.div className="group" variants={itemVariants}>
              <Card className="border-2 border-border/30 bg-gradient-to-br from-card to-card/80 rounded-2xl md:rounded-3xl shadow-xl overflow-hidden transition-all duration-300 ease-out hover:scale-[1.01] hover:shadow-2xl hover:-translate-y-1 h-full">
                <CardHeader className="pb-6 sm:pb-8 pt-6 sm:pt-8 md:pt-10 px-4 sm:px-6 md:px-8 lg:px-10">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-4 sm:mb-6">
                    <div className="bg-green-500/15 p-3 sm:p-4 rounded-2xl md:rounded-3xl flex-shrink-0">
                      <Globe className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-green-600" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-2 sm:mb-3">
                        E-commerce
                  ...
                  <div className="bg-muted/50 rounded-xl md:rounded-2xl p-3 sm:p-4 space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                    <div className="flex items-start space-x-2">
                    ...
                    <div className="flex items-start space-x-2 justify-end">
                      <div className="bg-green-500 text-white rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 max-w-[180px] sm:max-w-[200px]">
                        <p className="text-xs sm:text-sm">
                  ...
                  {/* Product preview */}
                  <div className="bg-background/50 rounded-lg sm:rounded-xl p-2.5 sm:p-3 mb-3 sm:mb-4 border-2 border-border">
                    <div className="flex items-center space-x-2.5 sm:space-x-3">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-sage-400 to-sage-600 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 lg:px-2 text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6 md:mb-8 leading-tight">
              Ready to Transform Your Webapp?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 md:mb-10 px-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <div className="relative group w-full sm:w-auto">
                ...
                <Button
                  asChild
                  size="lg"
                  className="relative bg-brand text-primary-foreground border-[3px] border-border hover:bg-brand/90 w-full sm:w-auto text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-5 rounded-lg"
                >
                  <Link href="/login">
                    <Play className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                    Create an Agent
