    ...
    <div className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{
          ...
          overflow: 'hidden',
          isolation: 'isolate',
          // Soft edge using box-shadow - adjust shadowIntensity to dial in
          boxShadow: (() => {
            const shadowIntensity = 1.5; // Adjust this: 0.5 = lighter, 2 = stronger
            return `
              0 0 ${15 * shadowIntensity}px rgba(255, 140, 90, ${0.25 * shadowIntensity}),
              0 0 ${30 * shadowIntensity}px rgba(255, 140, 90, ${0.15 * shadowIntensity}),
              0 0 ${45 * shadowIntensity}px rgba(255, 140, 90, ${0.1 * shadowIntensity}),
              0 0 ${60 * shadowIntensity}px rgba(255, 140, 90, ${0.05 * shadowIntensity})
            `;
          })(),
